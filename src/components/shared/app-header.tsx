...
import { Cog, Minus, Plus, Sparkles, PanelLeft } from 'lucide-react'; // Added PanelLeft
...
import { SidebarTrigger } from '@/components/ui/enhanced-sidebar'; // Added SidebarTrigger import
